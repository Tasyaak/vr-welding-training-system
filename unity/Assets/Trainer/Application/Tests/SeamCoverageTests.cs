...
namespace WeldingTrainer.Application.Tests
{
    public sealed class SeamCoverageTests
    {
        ...
        static PathMetrics M(
            double arc,
            MotionFlags flags = MotionFlags.None)
        {
            var projection = new SeamProjection(
                valid: true,
                ambiguous: false,
                segmentIndex: 0,
                arcLengthMetres: arc,
                progress: arc,
                positionWorkpieceMetres: new Vec3(arc, 0, 0),
                tangentWorkpiece: new Vec3(1, 0, 0));
            ...
            bool valid =
                ...
                MotionFlags.GenerationMismatch |
                MotionFlags.InputUnavailable |
                MotionFlags.InvalidInput |
                MotionFlags.ContextMismatch |
                MotionFlags.InvalidSurfaceFrame |
                MotionFlags.ProjectionUnavailable)) == 0;
            ...
            return new PathMetrics(
                ...
                errorVectorWorkpieceMetres: default,
                tangentialErrorMetres: 0d,
                lateralErrorMetres: 0d,
                normalErrorMetres: 0d,
                speedValid: true,
                signedSpeedMps: 0.1d,
                filteredSpeedMps: 0.1d,
                speedClass: SpeedClass.SpeedCorrect,
                travelAngleValid: true,
